  ...
  return (
    <div className="profile-container">
      ...
      {/* <div className="deactivation-section">
        <button onClick={goToDeactivate} className="deactivation-button">Deactivate Account</button>
      </div>
      ...
      <div className="deactivation-logout-section">
        <button onClick={goToDeactivate} className="deactivation-button">
          <FontAwesomeIcon icon={faUserSlash} /> Deactivate Account
        </button>
