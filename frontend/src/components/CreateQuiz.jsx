...
const CreateQuiz = () => {
  const [quiz, setQuiz] = useState({
    ...
    isPublicQuiz: false,
    allowedUser: [] // Added to hold allowed usersName
  });
          ...
          {quiz.questionList.map((question, index) => (
            <div key={index} className={styles.questionSection}>
              ...
              {Object.keys(question.options).map((optionKey) => (
                <div key={optionKey} clasName={styles.optionInput}>
                  <input
                    type="text"
              ...
              <button className={styles.addOptionButton} type="button" onClick={() => addOption(index)}>
                Add Option
              </button>
